...
use App\Http\Controllers\Dodajodpowiedzcontroller;
...
Route::post('/dodajodpowiedz', [Dodajodpowiedzcontroller::class, 'doajodpowiedz']);
Route::post('/gh', [GHcontroller::class, 'gh']);